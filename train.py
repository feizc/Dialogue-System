...
def train():
    ...
    for instance in dataset:
        ...
        loss = model(input_embs, token_type_ids, labels, img_features)
...
def input_construct(history_txt_embs, history_img_embs, token_type_ids, tokenizer):
    ...
    image_feature = torch.zeros((1, emb_dim))
    if img_idx < img_num - 1:
        image_feature[0,:] = history_img_embs[img_idx+1,:]
